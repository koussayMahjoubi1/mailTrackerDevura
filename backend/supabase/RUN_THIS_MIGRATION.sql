-- =====================================================
-- DEVURATRACKER DATABASE MIGRATION
...
-- Verify tables were created (this should return 4 rows)
SELECT 'Tables created successfully!' as status, 
       COUNT(*) as table_count
FROM information_schema.tables 
WHERE table_schema = 'public' 
AND table_name IN ('tracking_pixels', 'tracking_links', 'tracking_events', 'email_accounts');
